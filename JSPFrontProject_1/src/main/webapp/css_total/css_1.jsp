...
<%--
     1. CSS
           ...
           = 기본
              => 태그명
                 ...
                 * $('태그명').click(function(){}) => Jquery
                   document.querySelector(); => 일반 자바스크립트
                   new Vue({
                      el:'태그명'
                   })
               ...
               *** HTML => 계층구조 (트리형태)
               ...
               후손선택자
                  ...
                  h1     span ==> 자손 div > h1, div > span
                          ...
                          h1 ===> 후손
               자손 선택자
               인접 => div > h1+span => h1바로 옆에 있는 span태그 선택
                      div > h1~span => h1부터 span까지
               =================================================
               반응 선택자 :   ID명,class명,태그명:hover
                                       ========== mouseover
               구조 선택자 : nth-chid(수열)
                          nth-chid(2n) => n=0부터 = 0,2,4,6...
                          nth-chid(2n+1) => 1,3,5,..
               문자 선택자 : ::after, ::before 
               =================================================
        ...
        #192page => 위치 속성
        ------------------------------------
        static : 태그에 맞춰서 배치 (알아서 순서대로 배치 => 디폴트가 static)
        ------------------------------------
        relative : 상대 태그 좌표 이용 (옆에 있는 태그를 기준점으로)
        ------------------------------------
        absolute : 절대 좌표
        ------------------------------------
        fixed : 고정 => 상세보기
