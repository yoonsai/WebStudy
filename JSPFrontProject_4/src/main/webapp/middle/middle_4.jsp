...
window.onload=function(){
	const sawons=[
		...
		{sabun:2,name:'홍길동',dept:'영업부',loc:'부산',job:'과장'},
		{sabun:3,name:'홍길동',dept:'기획부',loc:'경기',job:'사원'},
		{sabun:4,name:'홍길동',dept:'자재부',loc:'인천',job:'부장'},
		{sabun:5,name:'홍길동',dept:'총무부',loc:'제주',job:'대리'}
	]
	let html='';
