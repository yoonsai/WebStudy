...
<body>
  ...
  <table class="table">
    ...
    <c:forEach var="vo" items="${list}">
      ...
      <td><img src="${vo.gvo.goods_poster}" style="width:30px;height: 30px"></td>
      ...
      <td class="text-center">
          <span class="btn btn-sm btn-danger" id="buyBtn" data-title="${vo.gvo.goods_name}" data-price="${vo.gvo.goods_price}" data-no="${vo.cart_no}">구매</span>
          <a href="../goods/cart_cancel.do?no=${vo.cart_no }" class="btn btn-sm btn-info">취소</a>
